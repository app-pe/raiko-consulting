...
<div class="container">
    <div class="row align-items-center pb-1">
        ...
        <small class="bg-primary text-white text-uppercase font-weight-bold px-1">Misión</small>
            <h1 class="mt-2 mb-4">Proveer servicios creativos para lograr la eficacia y eficiencia de su negocio.</h1>
